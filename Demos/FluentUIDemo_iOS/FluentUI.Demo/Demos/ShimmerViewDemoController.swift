...
class ShimmerViewDemoController: DemoController {
    override func viewDidLoad() {
        ...
        container.addArrangedSubview({
            let swiftUIButton = FluentUI.Button(style: .outlineAccent)
            swiftUIButton.setTitle("Show SwiftUI Demo", for: .normal)
    ...
    @objc private func showSwiftUIDemo() {
        navigationController?.pushViewController(ShimmerViewDemoControllerSwiftUI(),
                                                 animated: true)
    }
}
